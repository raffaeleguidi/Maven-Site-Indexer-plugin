...
d.add("text", "Project Distribution Management Last Published 2011 11 12   Version 0 0 1 SNAPSHOT Menu Overview Project Documentation Project Information Distribution Management About Dependencies Issue Tracking Project Plugins Continuous Integration Project License Mailing Lists Project Team Source Repository Plugin Management Project Summary Overview No distribution management is defined for this project Copyright © 2011 All Rights Reserved ");
...
var d = new LADDERS.search.document();
d.add("id", 'index.html');
d.add("text", "Maven Site Indexer Plugin Last Published 2011 11 12   Version 0 0 1 SNAPSHOT Menu Overview Project Documentation Project Information Distribution Management About Dependencies Issue Tracking Project Plugins Continuous Integration Project License Mailing Lists Project Team Source Repository Plugin Management Project Summary Maven Site Indexer plugin An easy way to index your maven site and give it a nice ajax search box It s as easy as putting searchbox html in site resources you can customize it if you have a good javascript fu putting search js in site js just put it as it is mvn site site index index don t site deploy it as this overwrites the added tags still working on this P open up your site and enjoy your nice and free search box Wanna see an example Look at the top right corner of this page Wanna try it It s apache licensed and you can find it on GitHub Copyright © 2011 All Rights Reserved ");
...
d.add("text", "Continuous Integration Last Published 2011 11 12   Version 0 0 1 SNAPSHOT Menu Overview Project Documentation Project Information Distribution Management About Dependencies Issue Tracking Project Plugins Continuous Integration Project License Mailing Lists Project Team Source Repository Plugin Management Project Summary Continuous Integration No continuous integration management system is defined Please check back at a later date Copyright © 2011 All Rights Reserved ");
...
d.add("text", "Issue Tracking Last Published 2011 11 12   Version 0 0 1 SNAPSHOT Menu Overview Project Documentation Project Information Distribution Management About Dependencies Issue Tracking Project Plugins Continuous Integration Project License Mailing Lists Project Team Source Repository Plugin Management Project Summary Issue Tracking No issue management system is defined Please check back at a later date Copyright © 2011 All Rights Reserved ");
...
d.add("text", "Project License Last Published 2011 11 12   Version 0 0 1 SNAPSHOT Menu Overview Project Documentation Project Information Distribution Management About Dependencies Issue Tracking Project Plugins Continuous Integration Project License Mailing Lists Project Team Source Repository Plugin Management Project Summary Project License No project license is defined for this project Copyright © 2011 All Rights Reserved ");
...
d.add("text", "Project Mailing Lists Last Published 2011 11 12   Version 0 0 1 SNAPSHOT Menu Overview Project Documentation Project Information Distribution Management About Dependencies Issue Tracking Project Plugins Continuous Integration Project License Mailing Lists Project Team Source Repository Plugin Management Project Summary Project Mailing Lists There are no mailing lists currently associated with this project Copyright © 2011 All Rights Reserved ");
...
d.add("text", "Project Plugin Management Last Published 2011 11 12   Version 0 0 1 SNAPSHOT Menu Overview Project Documentation Project Information Distribution Management About Dependencies Issue Tracking Project Plugins Continuous Integration Project License Mailing Lists Project Team Source Repository Plugin Management Project Summary Project Plugin Management GroupId ArtifactId Version org apache maven plugins maven antrun plugin 1 3 org apache maven plugins maven assembly plugin 2 2 beta 5 org apache maven plugins maven dependency plugin 2 1 org apache maven plugins maven release plugin 2 0 Copyright © 2011 All Rights Reserved ");
...
d.add("text", "Source Repository Last Published 2011 11 12   Version 0 0 1 SNAPSHOT Menu Overview Project Documentation Project Information Distribution Management About Dependencies Issue Tracking Project Plugins Continuous Integration Project License Mailing Lists Project Team Source Repository Plugin Management Project Summary Source Repository No source configuration management system is defined Please check back at a later date Copyright © 2011 All Rights Reserved ");
